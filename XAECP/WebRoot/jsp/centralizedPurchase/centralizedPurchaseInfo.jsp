...
<table id="register" class="CENTER" cellpadding="0" cellspacing="0" >
	<thead id="centralizedPurchaseInfoThead"><tr><td><s:property value="#request.centralizedPurchase.cpPurchaseInfoTitle"/></td></tr></thead>
	<tbody>
      <tr>
        <td>
        <table id="registCnt" class="CENTER" cellpadding="2px;" cellspacing="0">
          ...
          <tr>
            ...
            <td class="ALLEFT" id="publisherInfo"><s:property value="#request.centralizedPurchase.publisherName"/></td>
