...
<script type="text/javascript">
	   function checkNumber(valu){
     	...
     	function purchaserConfirmRejected(valu){
...
<form id="purchaserConfirmRejected" action="purchaserConfirmRejected.action">
	<input type="hidden" name="purchaseOrderId" id="purchaseOrderIdTag" value=""/>
	...
	<tr>	
      ...
      <tr>
      	<td align="center" style="padding-bottom:15px;">
            ...
            <input type="button" id="bigRedButton" class="BIGREDBUTTON" onclick="purchaserConfirmRejected()" value="确定退货" />
        </td>
      </tr>
  </table>
  <div id="DOWN">
