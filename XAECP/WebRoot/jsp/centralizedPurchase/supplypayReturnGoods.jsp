...
<script language="javascript">
	$().ready(function (){
		...
		$("#bigRedButton").attr("value","支付退款"+p+"（元）");
	});
	...
	function payReturnGoodes(){
		var actualRefundV=$("#actualRefund").attr("value");
		var baseOrderIdV=$("#spanLeft1").text().replace(/\D/g,"");
		var url="updateActualRefund.action";
		var params={actualRefund:actualRefundV,baseOrderId:baseOrderIdV};
	...
	<tr>	
      ...
      <tr>
      	<td align="center" style="padding-bottom:15px;">
            ...
            <div class="ORDERCONTENT"><span>实际退货款：<input id="actualRefund" type="text" />（元）</span></div>
            <input type="button" id="bigRedButton" onclick = "payReturnGoodes()" class="BIGREDBUTTON" />
        </td>
      </tr>
  </table>
  <div id="DOWN">
