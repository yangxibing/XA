...
<div id="top">
    ...
    <table id="showlist" class="CENTER" cellspacing="0" cellpadding="0">
        ...
        <tr>
            ...
            <td><input type="button"  class="BUTTON" name="<s:property value="#element.numberInterval"/>?*<s:property value="#element.productId"/>" onclick="edit(this)" value="编辑"></td>
        </tr>
       </s:iterator>
        <tr>
        <tr>
            ...
            <td colspan="2">
            <input type="button" class="BUTTON" onclick="deletePrice()" value="删除" />
            <input type="button" class="BUTTON" onclick="newPrice()" value="新建" />
            </td>
            <td colspan="2">
    ...
    <form id="newPriceForm" method="post">
    <table id="register" class="CENTER">
        ...
        <tr>
        	<td>
            	<table id="registCnt" class="CENTER" cellpadding="0" cellspacing="0">
                	<tr>
                    	<td class="ALRIGHT">数量区间</td>
                        <td class="ALLEFT">
                        	<input type="text" class="SMALLINPUT" id="startNumber"/>&#8211;<input type="text" id="endNumber" class="SMALLINPUT"/><font color="#FF0000">*</font>
                            </td>
                        <td class="ALRIGHT">度量单位</td>
                        <td class="ALLEFT"><input type="text" id="measureUnit" class="INPUTTEXT" /></td>
                    </tr>
                    <tr>
                    	
                    	<td class="ALRIGHT">价格</td>
                        <td class="ALLEFT"><input type="text" id="price" class="INPUTTEXT" /></td>
                        <td class="ALRIGHT">备注</td>
                        <td class="ALLEFT"><input type="text" id="remark" class="INPUTTEXT" /></td>
                    </tr>
                </table>
            </td>
        </tr>
        <tr>
        	<td align="center">
                ...
                <input type="button" class="BUTTON" onclick="hideRegister()" value="取消" />
            </td>
        </tr>
    </table>
    </form>
