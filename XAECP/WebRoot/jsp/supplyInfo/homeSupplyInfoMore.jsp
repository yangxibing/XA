...
function prePage(){
	...
	$("#queryAllSupplyForm").attr("action", "homeSupplyInfoMore.action?currentPage="+currentPage);
	$("#queryAllSupplyForm").submit();
}
...
<body>
<form action="homeSupplyInfoMore.action" id="queryAllSupplyForm" method="post"></form>
...
<!--[if !IE]>-------------------------------------<![endif]-->
    ...
    <div id="lead" class="DIVTITLE">
    	<span>您当前的位置:&nbsp;&nbsp;<a href="../../home.jsp ">首页</a>>诚信会员供货信息</span>
    </div>
    <div class="DIVCNT">	
