...
<div id="supply" class="CENTER">
    <div id="top">
      <h2><span style="color:#FFF;">退货详情</span></h2>
    </div>
<table id="register" class="CENTER" cellpadding="0" cellspacing="0">
	<tr>	
      	<td align="center">
            ...
            <span id="spanRight1" class="FLOATRIGHT"><a href="productManage.html" target="_blank">供应商产品目录</a></span>
        </td>
      </tr>
      <tr>
        <td>
      ...
      <tr>
      	<td align="center" style="padding-bottom:15px;">
            ...
            <div class="ORDERCONTENT"><span>实际退货款：<s:property value="#request.baseOrder.actualRefund"/>（元）</span></div>
        </td>
      </tr>
  </table>
  <div id="DOWN">
