...
function prePage(){
	...
	$("#queryAllCaigouInfoForm").attr("action", "homeCaigouInfoMore.action?currentPage="+currentPage);
	$("#queryAllCaigouInfoForm").submit();
}
...
<body>
<form action="homeCaigouInfoMore.action" id="queryAllCaigouInfoForm" method="post"></form>
...
<!--[if !IE]>-------------------------------------<![endif]-->
    ...
    <div id="lead" class="DIVTITLE">
    	<span>您当前的位置:&nbsp;&nbsp;<a href="../../home.jsp">首页</a>>采购/招标信息</span>
    </div>
    <div class="DIVCNT">	
    	<table id="contentTab" cellpadding="2px" cellspacing="0" class="CENTER">
            ...
            <s:iterator id="element" value="#request.query">
	        	<tr>
	        		<td class="CNT1"><a href="#"><s:property value="#element.title"/></a></td>
                	<td class="CNT2"><s:property value="#element.publishDate"/></td>
                	<td class="CNT3"><s:property value="#element.effectiveDate"/></td>
                	<td class="CNT4"><s:property value="#element.publisher"/></td>
	        	</tr>
	        </s:iterator>
        </table>
    </div>
