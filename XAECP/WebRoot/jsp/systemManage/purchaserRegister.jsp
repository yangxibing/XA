...
<title>西安印刷包装行业信息发布及集中采购网站采购商注册</title>
...
<script type="text/javascript">
	...
	function testJump(){
		if('<s:property value="#request.purchaserRegisterSuccess"/>' == "SUCCESS"){
			$("#timeCountDiv").show();
			$("#button").hide();
			 function jump(count) {  
	...
	function registSubmit(){
		...
		$.post(url, params, function(data){
			if(data.checkRegisterExistAjax == "exist"){
				...
				$("#purchaserRegisterSubmit").submit();
			}
...
<body>
	<form id="purchaserRegisterSubmit" action="purchaserRegisterSubmit.action" method="post">
	<div class="CENTER" id="sky">
	<div class="CENTER" id="title">
	<div class="CENTER" id="titleCnt">
	<span class="TITLESPAN1"><h1>采购商注册</h1></span><span class="TITLESPAN2">注：<font color="#FF0000">*</font>为必填项</span>
    </div>
</div>
	<div id="table">
