...
<script type="text/javascript">
	...
	function testJump(){
		if('<s:property value="#request.supplierRegisterSuccess"/>' == "SUCCESS"){
			$("#timeCountDiv").show();
			$("#button").hide();
			 function jump(count) {  
...
<body>
	<form id="supplierRegisterSubmit" action="supplierRegisterSubmit.action" method="post">
	<div class="CENTER" id="sky">
	<div class="CENTER" id="title">
	<div class="CENTER" id="titleCnt">
	<span class="TITLESPAN1"><h1>供应商注册</h1></span><span class="TITLESPAN2">注：<font color="#FF0000">*</font>为必填项</span>
    </div>
</div>
	<div id="table">
